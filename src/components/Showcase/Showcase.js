        ...
        <div className="w-33-l w-100 ph3 box tc mt0-l mt5">
            ...
            <div className="card-container center">
                ...
                <div className="flex justify-center mt2">
                    <a className="no-underline near-white bg-animate bg-near-black hover-bg-gray inline-flex items-center mr3 tc br2 pa1" href={githubLink} title="GitHub" target="_blank" rel="noreferrer">
                    ...
                    <a href={launchLink} className="f5 no-underline black bg-animate hover-bg-black hover-white inline-flex pa2 ba border-box br4" target="_blank" rel="noreferrer">
                        <svg className="w-1" data-icon="chevronLeft" viewBox="0 0 32 32" style={{ fill: "currentcolor" }}>
                            <title>chevronLeft icon</title>
                            <path d="M20 1 L24 5 L14 16 L24 27 L20 31 L6 16 z"></path>
                        </svg>
                        <span className="tc pa0 ma0">Launch</span>
                    </a>
                </div>
            </div>
        </div>
